...
- README: a **Roadmap** section stating what the blueprints already cover in a
  real installation — `socket-auto-off.yaml` applies to all 11 Schneider sockets
  found there, not only the 4 automations that motivated it — the three socket
  blueprints still worth writing, and the families deliberately left out because
  they are not Schneider ZHA hardware.
...
[3.0.1]: https://github.com/XIIIVI/schneider-electric-zha/releases/tag/v3.0.1
